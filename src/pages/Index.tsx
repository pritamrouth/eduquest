    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        <div className="mb-4 sm:mb-8 animate-fade-in">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent mb-2">
            Welcome back, Alex! 🎓
          </h1>
          <p className="text-muted-foreground text-sm sm:text-base lg:text-lg">Here's your learning progress overview</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <PerformanceCard
              ...
              score={88}
              trend={3}
              icon={<BookOpen className="w-4 sm:w-5 h-4 sm:h-5" />}
            />
          </div>
